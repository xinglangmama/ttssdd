...
<?php endif; ?> 
 [<a href="http://www.ecmoban.com" target="_blank" title="<?php echo $this->_var['link']['name']; ?>">ecshop</a>]
 </div>
 </div>
</div>
...
<div id="bottomNav" class="box">
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_13650300_1406383616');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_13650300_1406383616']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_13650300_1406383616']['url']; ?>" <?php if ($this->_var['nav_0_13650300_1406383616']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_13650300_1406383616']['name']; ?></a>
