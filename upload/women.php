...
function index_get_cat_id_goods_hot_list($cat_id, $num)
{
    $sql = 'Select g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.shop_price, g.promote_price, ' .
                "promote_start_date, promote_end_date, g.goods_brief, g.goods_thumb, goods_img, " .
                "g.is_best, g.is_new, g.is_hot, g.is_promote " .
            'FROM ' . $GLOBALS['ecs']->table('goods') . ' AS g ' .
            "Where g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.is_delete = 0 AND g.is_hot = 1 AND g.cat_id = '$cat_id'".
            " LIMIT $num";
    $res = $GLOBALS['db']->getAll($sql);
...
function index_get_cat_id_goods_new_list($cat_id, $num)
{
    $sql = 'Select g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.shop_price, g.promote_price, ' .
                ...
                "g.is_best, g.is_new, g.is_hot, g.is_promote " .
            'FROM ' . $GLOBALS['ecs']->table('goods') . ' AS g ' .
            "Where g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.is_delete = 0 AND g.is_new = 1 AND g.cat_id = '$cat_id'".
            " LIMIT $num";
    $res = $GLOBALS['db']->getAll($sql);
...
if (!$smarty->is_cached('women.dwt', $cache_id))
{
    assign_template();
    ...
    $smarty->assign('cat_id18_best_goods', index_get_cat_id_goods_best_list(18,6));
	$smarty->assign('cat_id18_hot_goods', index_get_cat_id_goods_hot_list(18,4));
	$smarty->assign('cat_id18_new_goods', index_get_cat_id_goods_new_list(18,4));
...
$smarty->display('women.dwt', $cache_id);
